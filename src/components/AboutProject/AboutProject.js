      ...
      <div className='about-project__main'>
        ...
        <ul className='about-project__progress'>
          <li className='about-project__progress-stage'>
            <h3 className='about-project__progress-stage-title about-project__progress-stage-title_type_first'>1 неделя</h3>
            <p className='about-project__progress-stage-description'>Back-end</p>
          </li>
          <li className='about-project__progress-stage about-project__progress-stage_type_second'>
            <h3 className='about-project__progress-stage-title about-project__progress-stage-title_type_second'>4 недели</h3>
            <p className='about-project__progress-stage-description'>Front-end</p>
          </li>
        </ul>
      </div>
    </section>
